 ...
 */
abstract class BannerOrientationHelper {
    ...
    private BannerOrientationHelper(RecyclerView.LayoutManager layoutManager) {
     ...
     */
    public static BannerOrientationHelper createOrientationHelper(
     ...
     * @return A new OrientationHelper
     */
    public static BannerOrientationHelper createHorizontalHelper(
            RecyclerView.LayoutManager layoutManager) {
        return new BannerOrientationHelper(layoutManager) {
            @Override
     ...
     * @return A new OrientationHelper
     */
    public static BannerOrientationHelper createVerticalHelper(RecyclerView.LayoutManager layoutManager) {
        return new BannerOrientationHelper(layoutManager) {
            @Override
            public int getEndAfterPadding() {
